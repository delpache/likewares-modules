...
class ModelMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Créer un nouveau modèle pour le module spécifié.';
    ...
    {
        return [
            ['fillable', null, InputOption::VALUE_OPTIONAL, 'Attributs remplissable.', null],
            ['migration', 'm', InputOption::VALUE_NONE, 'Indicateur pour créer les migrations associées', null],
            ['factory', 'f', InputOption::VALUE_NONE, 'Indicateur pour créer une factory associée', null],
        ];
    }
